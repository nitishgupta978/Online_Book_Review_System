package com.edureka.spring.obrs.bootstrap;

import com.edureka.spring.obrs.author.entity.Author;
import com.edureka.spring.obrs.author.service.AuthorService;
...
import com.edureka.spring.obrs.category.service.CategoryService;
import com.edureka.spring.obrs.common.service.StorageService;
import com.edureka.spring.obrs.common.service.StorageServiceImpl;
import com.edureka.spring.obrs.common.utils.EncryptionUtil;
import com.edureka.spring.obrs.publisher.service.PublisherService;
...
import com.edureka.spring.obrs.role.service.RoleService;
...
/*        loadRoles();
    ...
    private void loadUsers() {
        ...
        user1.setEmail("niti@test.com");
        user1.setDescription("Nitish have the USER role");
        ...
        user2.setFirstName("Kishlay");
        user2.setLastName("Kishan");
        user2.setEmail("kishan.kishlay@test.com");
        user2.setDescription("Kishan have the ADMIN role");
        ...
        user3.setFirstName("Ravi");
        user3.setLastName("Kumar");
        user3.setEmail("rk@test.com");
        user3.setDescription("XYZ Publications-Ravi have the PUBLISHER role");
